...
| File | What |
|---|---|
| [`results/verify/`](results/verify/) | **the reproducible model** — 73 theory scripts; map in [`results/verify/README.md`](results/verify/README.md) |
| [`results/verify/verify_all.py`](results/verify/verify_all.py) | the harness (**76/76**, CI-gated) |
