...
command (91/91), and this page also maps exactly **what is settled vs what is frontier** — that honest boundary
...
python results/verify/verify_all.py      # 91/91 PASS, deterministic, no network
```
