...
command (87/87), and this page also maps exactly **what is settled vs what is frontier** — that honest boundary
...
python results/verify/verify_all.py      # 87/87 PASS, deterministic, no network
```
