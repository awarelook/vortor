...
command (90/90), and this page also maps exactly **what is settled vs what is frontier** — that honest boundary
...
python results/verify/verify_all.py      # 90/90 PASS, deterministic, no network
```
