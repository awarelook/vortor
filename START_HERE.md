...
command (88/88), and this page also maps exactly **what is settled vs what is frontier** — that honest boundary
...
python results/verify/verify_all.py      # 88/88 PASS, deterministic, no network
```
