...
command (89/89), and this page also maps exactly **what is settled vs what is frontier** — that honest boundary
...
python results/verify/verify_all.py      # 89/89 PASS, deterministic, no network
```
