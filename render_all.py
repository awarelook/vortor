...
This is the PUBLICATION layer, downstream of the verified [V] core. It consumes the SAME numbers the 92 checks
...
files, so this driver and engine/viz/ never change the harness count (92/92). Rendering needs the quarantined viz deps:
