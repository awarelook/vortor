...
python results/verify/verify_all.py      # 83/83 PASS, exit 0 iff all pass
```

`verify_all.py` globs every `results/verify/*.py` (80 theory scripts) + the three engine files
