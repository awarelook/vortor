...
python results/verify/verify_all.py      # 81/81 PASS, exit 0 iff all pass
```

`verify_all.py` globs every `results/verify/*.py` (78 theory scripts) + the three engine files
