...
python results/verify/verify_all.py      # 87/87 PASS, exit 0 iff all pass
```

`verify_all.py` globs every `results/verify/*.py` (84 theory scripts) + the three engine files
