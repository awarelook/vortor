...
python results/verify/verify_all.py      # 82/82 PASS, exit 0 iff all pass
```

`verify_all.py` globs every `results/verify/*.py` (79 theory scripts) + the three engine files
