...
python results/verify/verify_all.py      # 88/88 PASS, exit 0 iff all pass
```

`verify_all.py` globs every `results/verify/*.py` (85 theory scripts) + the three engine files
