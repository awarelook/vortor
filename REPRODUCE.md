...
python results/verify/verify_all.py      # 89/89 PASS, exit 0 iff all pass
```

`verify_all.py` globs every `results/verify/*.py` (86 theory scripts) + the three engine files
