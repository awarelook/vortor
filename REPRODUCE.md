...
python results/verify/verify_all.py      # 78/78 PASS, exit 0 iff all pass
```

`verify_all.py` globs every `results/verify/*.py` (75 theory scripts) + the three engine files
