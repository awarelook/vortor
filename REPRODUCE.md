...
python results/verify/verify_all.py      # 86/86 PASS, exit 0 iff all pass
```

`verify_all.py` globs every `results/verify/*.py` (83 theory scripts) + the three engine files
