...
python results/verify/verify_all.py      # 84/84 PASS, exit 0 iff all pass
```

`verify_all.py` globs every `results/verify/*.py` (81 theory scripts) + the three engine files
