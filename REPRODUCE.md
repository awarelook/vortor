...
python results/verify/verify_all.py      # 85/85 PASS, exit 0 iff all pass
```

`verify_all.py` globs every `results/verify/*.py` (82 theory scripts) + the three engine files
