...
and a matter wave. Author: Nathaniel Hanks · v1.1 · reproduce: `python results/verify/verify_all.py` (**77/77**,
...
python results/verify/verify_all.py      # 77/77 PASS, deterministic, no network, CI-gated
```
