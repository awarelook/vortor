...
and a matter wave. Author: Nathaniel Hanks · v1.1 · reproduce: `python results/verify/verify_all.py` (**92/92**,
...
python results/verify/verify_all.py      # 92/92 PASS, deterministic, no network, CI-gated
```
