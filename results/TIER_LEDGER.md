...
*Provenance: the 67 `results/verify/` scripts + engine + the synthesis modeler + the resonator simulation `engine/ftgb_resonator_sim.py` (`verify_all.py` → **70/70** PASS) + the `results/` and `handoffs/` docs
