...
*Provenance: the 45 `results/verify/` scripts + engine + the synthesis modeler `engine/ftgb_synthesis_modeler.py` (`verify_all.py` → **47/47** PASS) + the `results/` and `handoffs/` docs
