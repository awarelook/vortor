...
*Provenance: the 38 `results/verify/` scripts + engine + the synthesis modeler `engine/ftgb_synthesis_modeler.py` (`verify_all.py` → **40/40** PASS) + the `results/` and `handoffs/` docs
