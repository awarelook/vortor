...
*Provenance: the 49 `results/verify/` scripts + engine + the synthesis modeler `engine/ftgb_synthesis_modeler.py` (`verify_all.py` → **51/51** PASS) + the `results/` and `handoffs/` docs
