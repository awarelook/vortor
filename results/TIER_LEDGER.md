...
*Provenance: the 78 `results/verify/` scripts + engine + the synthesis modeler + the resonator simulation `engine/ftgb_resonator_sim.py` (`verify_all.py` → **81/81** PASS) + the `results/` and `handoffs/` docs
