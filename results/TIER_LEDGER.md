...
*Provenance: the 46 `results/verify/` scripts + engine + the synthesis modeler `engine/ftgb_synthesis_modeler.py` (`verify_all.py` → **48/48** PASS) + the `results/` and `handoffs/` docs
