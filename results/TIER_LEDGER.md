...
*Provenance: the 40 `results/verify/` scripts + engine + the synthesis modeler `engine/ftgb_synthesis_modeler.py` (`verify_all.py` → **42/42** PASS) + the `results/` and `handoffs/` docs
