...
*Provenance: the 43 `results/verify/` scripts + engine + the synthesis modeler `engine/ftgb_synthesis_modeler.py` (`verify_all.py` → **45/45** PASS) + the `results/` and `handoffs/` docs
