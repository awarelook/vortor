...
*Provenance: the 63 `results/verify/` scripts + engine + the synthesis modeler + the resonator simulation `engine/ftgb_resonator_sim.py` (`verify_all.py` → **66/66** PASS) + the `results/` and `handoffs/` docs
