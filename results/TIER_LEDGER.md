...
*Provenance: the 44 `results/verify/` scripts + engine + the synthesis modeler `engine/ftgb_synthesis_modeler.py` (`verify_all.py` → **46/46** PASS) + the `results/` and `handoffs/` docs
