...
*Provenance: the 39 `results/verify/` scripts + engine + the synthesis modeler `engine/ftgb_synthesis_modeler.py` (`verify_all.py` → **41/41** PASS) + the `results/` and `handoffs/` docs
