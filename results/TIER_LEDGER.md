...
*Provenance: the 37 `results/verify/` scripts + engine + the synthesis modeler `engine/ftgb_synthesis_modeler.py` (`verify_all.py` → **39/39** PASS) + the `results/` and `handoffs/` docs
