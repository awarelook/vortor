...
*Provenance: the 64 `results/verify/` scripts + engine + the synthesis modeler + the resonator simulation `engine/ftgb_resonator_sim.py` (`verify_all.py` → **67/67** PASS) + the `results/` and `handoffs/` docs
