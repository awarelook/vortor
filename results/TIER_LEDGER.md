...
*Provenance: the 47 `results/verify/` scripts + engine + the synthesis modeler `engine/ftgb_synthesis_modeler.py` (`verify_all.py` → **49/49** PASS) + the `results/` and `handoffs/` docs
