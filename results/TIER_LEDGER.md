...
*Provenance: the 68 `results/verify/` scripts + engine + the synthesis modeler + the resonator simulation `engine/ftgb_resonator_sim.py` (`verify_all.py` → **71/71** PASS) + the `results/` and `handoffs/` docs
