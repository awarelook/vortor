...
*Provenance: the 41 `results/verify/` scripts + engine + the synthesis modeler `engine/ftgb_synthesis_modeler.py` (`verify_all.py` → **43/43** PASS) + the `results/` and `handoffs/` docs
