...
*Provenance: the 71 `results/verify/` scripts + engine + the synthesis modeler + the resonator simulation `engine/ftgb_resonator_sim.py` (`verify_all.py` → **78/78** PASS) + the `results/` and `handoffs/` docs
