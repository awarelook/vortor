...
## 3c. α as internal spin precession is correctly-typed (g−2); the value stays open

Pressing the *spin-precession* form of Reed's claim: the electron's **anomalous magnetic moment `a = (g−2)/2`
is *exactly* an internal spin precession**, generated by its coupling to the radiation field. The coupling
*does* manifest internally, as a precession. Grounded in `results/verify/g2_spin_precession_check.py`:
...
**Net:** "α as internal spin precession" is correctly-typed and maps
onto real g−2 physics. But the **value** of α stays open: it is the
