...
Nathaniel Hanks · 2026-09-15 · reproduce: `pip install -r requirements.txt && python results/verify/verify_all.py` → **86/86**, deterministic, no network, CI-gated.
...
One command reproduces the entire model (86 checks: 83 theory scripts + 3 engine runs), deterministic and
